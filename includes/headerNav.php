...
<a id="smallScreen" data-target="#topMenu" data-toggle="collapse" class="btn btn-navbar">
  ...
  <div class="navbar-inner">
   <a class="brand" href="index.php?id=<?php echo (isset( $_SESSION['customer_name']))? $_SESSION['id']: 'unknown';?>" style="opacity:0.8"><img width="200px" src="images/<?php echo $_SESSION['web-img']; ?>" alt="electricshop"/></a>
